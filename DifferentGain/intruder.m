classdef intruder < handle
    ...
    methods
        ...
        function obj = intruder(init_pos, init_dir,detect,behav,act,obstacle,critic,sp,target)
        ...
        function greedyMove(obj,world)
           ...
           for y = 1:size(actions,2)
               ...
               I_noNash (y)= -obj.critic_factor*l_dist_player_critic -obj.obstacle_factor*(1/l_min_dist_player_nearobs_otherplayer_NoNash);
