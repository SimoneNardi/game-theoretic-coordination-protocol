...
intruder_bheaviour=3; % 1: DEBUG (intruso aderisce strategie Nash)
...
safeZone =[60,60; 400,100]; %[lato1,lato2; xpos,ypos] Safe zone è unica!
...
%E' possibile aggiungere quante zone critiche si vuole
criticalAreas=[60,60; 500 500; 500 800]; %[lato1,lato2; xpos1,ypos1; xpos2,ypos2; ... ]
intruder_target=1; % selezionare quale tra le zone critiche elecante sopra 
                   % sia l'obbiettivo dell'intruso.

safeZone =[60,60; 500,300;]; %[lato1,lato2; xpos,ypos] Safe zone è unica!
...
robot1=defender([400,500],pi,detection_radius,comunication_radius,actions,formation_extension,obstacle_factor,barrier_factor,speed_defensors_max,speed_defensors_min,formation_radius,identification,identification_buffer);
robot2=defender([400,800],pi,detection_radius,comunication_radius,actions,formation_extension,obstacle_factor,barrier_factor,speed_defensors_max,speed_defensors_min,formation_radius,identification,identification_buffer);
robot3=defender([700,250],pi,detection_radius,comunication_radius,actions,formation_extension,obstacle_factor,barrier_factor,speed_defensors_max,speed_defensors_min,formation_radius,identification,identification_buffer);
...
%creo l'intruso
intruder1=intruder([500,600],0,detection_radius,intruder_bheaviour,actions,obstacle_factor,speed_intruder,intruder_target);
